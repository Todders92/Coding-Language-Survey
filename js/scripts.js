...
$(document).ready(function() {
  $("form#quiz").submit(function(event) {
    ...
    var q3 = parseInt($("input:radio[name=problem]:checked").val());
    var q4 = parseInt($("input:radio[name=problem]:checked").val());
    var q5 = parseInt($("input:radio[name=problem]:checked").val());
